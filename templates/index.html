...
<div id="tpor" class="hidden">
      <div class="card">
        <div class="row-between" style="margin-bottom:1rem">
          ...
          <div class="row" style="gap:8px"><button class="btn btn-sm" onclick="openOtroProductoModal(null,null,'porcion')"><i class="ti ti-plus"></i> Nueva porción</button>
                    <button class="btn btn-sm" onclick="openImportarRecetasModal('porcion')"><i class="ti ti-file-upload"></i> Importar desde PDF</button></div>
        </div>
...
<div id="tens" class="hidden">
      <div class="card">
        <div class="row-between" style="margin-bottom:1rem">
          ...
          <div class="row" style="gap:8px"><button class="btn btn-sm" onclick="openOtroProductoModal(null,null,'ensalada')"><i class="ti ti-plus"></i> Nueva ensalada</button>
                    <button class="btn btn-sm" onclick="openImportarRecetasModal('ensalada')"><i class="ti ti-file-upload"></i> Importar desde PDF</button></div>
        </div>
...
<div id="tent" class="hidden">
      <div class="card">
        <div class="row-between" style="margin-bottom:1rem">
          ...
          <div class="row" style="gap:8px"><button class="btn btn-sm" onclick="openOtroProductoModal(null,null,'entrada')"><i class="ti ti-plus"></i> Nueva entrada</button>
                    <button class="btn btn-sm" onclick="openImportarRecetasModal('entrada')"><i class="ti ti-file-upload"></i> Importar desde PDF</button></div>
        </div>
...
<div id="tplc" class="hidden">
      <div class="card">
        <div class="row-between" style="margin-bottom:1rem">
          ...
          <div class="row" style="gap:8px"><button class="btn btn-sm" onclick="openOtroProductoModal(null,null,'plato_caliente')"><i class="ti ti-plus"></i> Nuevo plato</button>
                    <button class="btn btn-sm" onclick="openImportarRecetasModal('plato_caliente')"><i class="ti ti-file-upload"></i> Importar desde PDF</button></div>
        </div>
...
function renderOtroProductoCfgTipo(tipo, containerId, renderFnName) {
  ...
  let h='<table><thead><tr><th>Producto</th><th>Rolls</th><th>Insumos y semielaborados</th><th>Marca(s)</th><th style="width:90px"></th></tr></thead><tbody>';
  lista.forEach(p=>{
